  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(loginThunk.fulfilled, (state, action) => {
        state.status = "succeeded" // Requête réussie
        // L'utilisateur a été ajouté dans l'état via addUser
      })
      .addCase(loginThunk.rejected, (state, action) => {
        state.status = "failed" // Requête échouée
        state.error = action.error.message // Sauvegarde l'erreur
      })
  },
})
